...
import com.example.usuario.ludiuca.adaptadores.AdaptadorClase;
 ...
 */
public class AltaTareaActivity extends ActionBarActivity{
        @Override
        protected void onCreate(Bundle savedInstanceState){
            ...
            AdaptadorAltaTarea adaptadoraltatarea= new AdaptadorAltaTarea(getSupportFragmentManager(), getApplicationContext());
            contenedorTabs.setAdapter(adaptadoraltatarea);
