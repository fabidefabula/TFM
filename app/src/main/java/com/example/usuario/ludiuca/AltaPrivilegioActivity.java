...
import com.example.usuario.ludiuca.adaptadores.AdaptadorAltaPrivilegio;
 ...
 */
public class AltaPrivilegioActivity extends ActionBarActivity{
        @Override
        protected void onCreate(Bundle savedInstanceState){
            ...
            AdaptadorAltaPrivilegio adaptadoraltaprivilegio= new AdaptadorAltaPrivilegio(getSupportFragmentManager(), getApplicationContext());
            contenedorTabs.setAdapter(adaptadoraltaprivilegio);
