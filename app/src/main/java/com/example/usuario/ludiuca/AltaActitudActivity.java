 ...
 */
public class AltaActitudActivity extends ActionBarActivity{
        @Override
        protected void onCreate(Bundle savedInstanceState){
            ...
            AdaptadorAltaActitud adaptadoraltaactitud= new AdaptadorAltaActitud(getSupportFragmentManager(), getApplicationContext());
            contenedorTabs.setAdapter(adaptadoraltaactitud);
