 ...
 */
public class ClaseActivity extends ActionBarActivity{
        @Override
        protected void onCreate(Bundle savedInstanceState){
            super.onCreate(savedInstanceState);
            setContentView(R.layout.fragmento_tabs);
            final List<SamplePagerItem> tabs = new ArrayList<SamplePagerItem>();
            tabs.add(new SamplePagerItem("Clase", Color.WHITE, Color.WHITE));
            tabs.add(new SamplePagerItem("Grupos", Color.WHITE, Color.WHITE));
            tabs.add(new SamplePagerItem("noti", Color.WHITE, Color.WHITE));
            ViewPager contenedorTabs = (ViewPager)findViewById(R.id.pager);
            AdaptadorVerAlumnos adaptadorclase = new AdaptadorVerAlumnos(getSupportFragmentManager(), getApplicationContext());
            contenedorTabs.setAdapter(adaptadorclase);
